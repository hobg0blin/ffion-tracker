#!/usr/bin/env python3
"""
Cat detector using YOLO and image description model.
Monitors webcam feed for cats, captures images, describes them, and posts to the server.
"""
...
SERVER_URL = "http://127.0.0.1:3000/ffion/status"
...
class CatDetector:
    ...
    def _load_cookie(self):
        ...
        if not Path(COOKIE_FILE).exists():
            ...
            print("Visit http://127.0.0.1:3000/get-cookie to get your session cookie.")
            return None
